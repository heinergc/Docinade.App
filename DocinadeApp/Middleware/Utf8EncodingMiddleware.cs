...
{
    /// <summary>
    /// Middleware para asegurar que todas las respuestas usen codificaci�n UTF-8
    /// </summary>
    public class Utf8EncodingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            context.Response.OnStarting(() =>
            {
                try
                {
                    // Configurar Content-Type con UTF-8 si no est� establecido
                    ...
                    {
                        // Agregar charset UTF-8 si no est� presente
    ...
    /// <summary>
    /// Extensi�n para registrar el middleware de UTF-8
    /// </summary>
