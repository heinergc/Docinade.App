...
namespace RubricasApp.Web.Migrations
{
    ...
    [Migration("20260313184032_AgregarConfiguracionComponenteSEA")]
    partial class AgregarConfiguracionComponenteSEA
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RubricasApp.Web.Models.Estudiante", b =>
                {
                    ...
                    b.Property<bool>("AplicarACSPeriodosAnteriores")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<string>("DetallesACS")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<DateTime?>("FechaInicioACS")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int?>("PeriodoInicioACSId")
                        .HasColumnType("int");

                    b.Property<string>("TipoAdecuacion")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)")
                        .HasDefaultValue("NoPresenta");
            ...
            modelBuilder.Entity("RubricasApp.Web.Models.EstudianteInstrumentoACS", b =>
                {
                    ...
                    b.Property<string>("CriteriosAdaptados")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.Property<decimal?>("PonderacionPersonalizadaPorcentaje")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");

                    b.Property<int?>("RubricaModificadaId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InstrumentoEvaluacionId");

                    b.HasIndex("PeriodoAcademicoId");

                    b.HasIndex("RubricaModificadaId");

                    b.HasIndex("EstudianteId", "InstrumentoEvaluacionId", "PeriodoAcademicoId")
                        .IsUnique()
            ...
            modelBuilder.Entity("RubricasApp.Web.Models.SEA.ConfiguracionComponenteSEA", b =>
                {
                    ...
                    b.Property<string>("ComponenteSEA")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("UsuarioConfiguracion")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.HasIndex("MateriaId", "ComponenteSEA");

                    b.HasIndex("MateriaId", "InstrumentoEvaluacionId")
                        .IsUnique();
