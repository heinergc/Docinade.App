# Script simplificado para publicar RubricasApp en IIS Local (sin try/catch)
# Ejecutar como Administrador
# Guardar como: Publish-RubricasApp_v3.ps1
...
# Hacer que cualquier error detenga la ejecución
...
if ($LASTEXITCODE -ne 0) { throw "Error al publicar la aplicación. Código de salida: $LASTEXITCODE" }
